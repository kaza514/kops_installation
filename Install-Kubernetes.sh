...
KOPS_HOME=/home/ec2-user/kops
KUBE_HOME=$KOPS_HOME/kubectl
SUBDOMAIN_NAME=demo.k8s.manojy.co.in
...
installKops() {
        ...
        #curl -L0 https://github.com/kubernetes/kops/releases/download/1.6.1/kops-linux-amd64
...
deleteCluster() {
        kops delete cluster --name $SUBDOMAIN_NAME --yes
